...
const forms = state => {
  ...
  forms.forEach(form => {
    form.addEventListener('submit', e => {
      ...
      postData('https://jsonplaceholder.typicode.com/posts', json).then(res => {
        console.log(res);
        ...
        (0,_modal__WEBPACK_IMPORTED_MODULE_1__.closeModalByTime)('.popup_engineer');
        (0,_modal__WEBPACK_IMPORTED_MODULE_1__.closeModalByTime)('.popup_calc_end');
        (0,_modal__WEBPACK_IMPORTED_MODULE_1__.closeModalByTime)('.popup');
      });
    });
  });
};
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const tabs = function (tabSelector, contentSelector, headerSelector, activeClass) {
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.glazing_block', '.glazing_content', '.glazing_slider', 'active');
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.no_click', '.decoration_content > div > div', '.decoration_slider', 'after_click');
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.balcon_icons_img', '.big_img > img', '.balcon_icons', 'do_image_more', 'inline-block');
